...
== tasks calling rhel-system-roles.network

An example playbook is included with the RPM, here. 
...
== CLI equivalents of calls to rhel-system-roles.network
...
== tasks calling community.libvirt.virt_net

https://docs.ansible.com/ansible/latest/collections/community/libvirt/virt_net_module.html

== CLI equivalents of calls to community.libvirt.virt_net
